...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen3_17b_bf16_openthoughts_math_30k_megatron_opd_full_vocab_oft
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen3-1.7B_4B_Instruct2507_openthoughts_math_30k_opd_full_vocab_oft"
...
EVAL_ARGS=(
    ...
    --eval-apply-chat-template-kwargs '{"enable_thinking": true}'
    --eval-top-k -1
    --eval-top-p 0.95
    --eval-temperature 1.0
    --eval-pass-k-values 1 2 4 8 12
)
