...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen3_17b_bf16_openreasoning100k_megatron_full_vocab_opd_full
...
SAVE_DIR="${ORBIT_ROOT}/orbit_ckpts/Qwen3-1.7B_4B_Instruct2507_openreasoning100k_full_vocab_opd_full_fkl"
